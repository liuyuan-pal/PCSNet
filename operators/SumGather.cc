...
class SumGatherOp: public OpKernel
{
public:
    explicit SumGatherOp(OpKernelConstruction* context) : OpKernel(context)
    {
    ...
    void Compute(OpKernelContext* context) override
    {
        ...
        sumGather(feats_p,nlens_p,nbegs_p,m,f,feats_gather_p);
    }
};

REGISTER_KERNEL_BUILDER(Name("SumGather").Device(DEVICE_GPU), SumGatherOp);