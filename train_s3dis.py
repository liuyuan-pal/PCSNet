...
parser.add_argument('--train_dir', type=str, default='train/pointnet_13_dilated_embed_test', help='')
parser.add_argument('--save_dir', type=str, default='model/pointnet_13_dilated_embed_test', help='')
parser.add_argument('--log_file', type=str, default='log/pointnet_13_dilated_embed_test.log', help='')
